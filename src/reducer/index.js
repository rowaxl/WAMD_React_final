...
const initialState = {
  dataRows: localStorage.getItem('dataRows')
    ? JSON.parse(localStorage.getItem('dataRows'))
    : [
...
const reducer = (
  ...
  switch (action.type) {
    case ActionTypes.ADD_ROW: {
      const newDataRows = [...state.dataRows, action.payload]

      localStorage.setItem('dataRows', JSON.stringify(newDataRows))
